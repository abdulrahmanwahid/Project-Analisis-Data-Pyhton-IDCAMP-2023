...
all_df = pd.read_csv("https://github.com/abdulrahmanwahid/Project-Analisis-Data-Pyhton-IDCAMP-2023/raw/main/streamlit/df.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv("https://github.com/abdulrahmanwahid/Project-Analisis-Data-Pyhton-IDCAMP-2023/raw/main/streamlit/geolocation.csv")
...
with st.sidebar:
    ...
    with col1:
        st.write(' ')
    with col2:
        st.image("https://user-images.githubusercontent.com/7164864/217935870-c0bc60a3-6fc0-4047-b011-7b4c59488c91.png"
                 , width=100)
    with col3:
        st.write(' ')

...
all_df = pd.read_csv("https://raw.githubusercontent.com/abdulrahmanwahid/Project-Analisis-Data-Pyhton-IDCAMP-2023/main/dataset/all_data.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv("https://raw.githubusercontent.com/abdulrahmanwahid/Project-Analisis-Data-Pyhton-IDCAMP-2023/main/dashboard/geolocation.csv")

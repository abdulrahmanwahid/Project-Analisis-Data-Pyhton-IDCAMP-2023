...
all_df = pd.read_csv("https://raw.githubusercontent.com/abdulrahmanwahid/Project-Analisis-Data-Pyhton-IDCAMP-2023/main/streamlit/df.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv("https://raw.githubusercontent.com/abdulrahmanwahid/Project-Analisis-Data-Pyhton-IDCAMP-2023/main/streamlit/geolocation.csv")
...
with st.sidebar:
    ...
    with col1:
        st.write(' ')
    with col2:
        st.image("https://github.com/abdulrahmanwahid/Project-Analisis-Data-Pyhton-IDCAMP-2023/blob/main/streamlit/logo.png"
                 , width=100)
    with col3:
        st.write(' ')
